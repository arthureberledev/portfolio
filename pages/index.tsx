...
export default function Home() {
  return (
    <>
      <Head>
        <title>Arthur Eberle - Web developer</title>
        <meta
          name="description"
          content="Hey, I'm Arthur! I'm a passionate web developer from Nuremberg who works on various projects in his spare time."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            Hey, I&apos;m Arthur! I&apos;m a passionate web developer from
            Nuremberg who works on various projects in his spare time. I&apos;m
            currently completing my Master&apos;s degree in Computer Science at
            the Georg Simon Ohm University of Applied Sciences in Nuremberg and
            work at DATEV eG in the UX/CX department.
          </p>
